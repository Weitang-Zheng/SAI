 ...
 */
typedef struct _sai_alloc_info_t
{
    uint32_t list_size;
     ...
     */
    const sai_attribute_t *reference;
} sai_alloc_info_t;

/**
 * @brief Allocate sai_attribute_t value
 *
 ...
 * #SAI_STATUS_INVALID_PARAMETER/#SAI_STATUS_NO_MEMORY on failure
 */
extern sai_status_t sai_metadata_alloc_attr_value(
        _In_ const sai_attr_metadata_t *metadata,
        _In_ const sai_attribute_t *attr,
        _In_ const sai_alloc_info_t *info);

/**
 * @brief Free sai_attribute_t value
 *
 * @param[in] metadata Attribute metadata
 ...
 *
 * @return #SAI_STATUS_SUCCESS on success,
 * #SAI_STATUS_INVALID_PARAMETER on failure
 */
extern sai_status_t sai_metadata_free_attr_value(
        _In_ const sai_attr_metadata_t *metadata,
        _In_ const sai_attribute_t *attr,
        _In_ const sai_alloc_info_t *info);

/**
 * @brief Clear sai_attribute_t value
 *
 * @param[in] metadata Attribute metadata
 ...
 * #SAI_STATUS_INVALID_PARAMETER on failure
 */
extern sai_status_t sai_metadata_clear_attr_value(
        _In_ const sai_attr_metadata_t *metadata,
        _In_ const sai_attribute_t *attr);

/**
 * @brief Deep copy sai_attribute_t value
 *
 * @param[in] metadata Attribute metadata
 ...
 * #SAI_STATUS_INVALID_PARAMETER on failure
 */
extern sai_status_t sai_metadata_deepcopy_attr_value(
        _In_ const sai_attr_metadata_t *metadata,
        _In_ const sai_attribute_t *src,
        _Inout_ sai_attribute_t *dest);

/**
 * @brief Deep equal sai_attribute_t value
 *
 * @param[in] metadata Attribute metadata
 * @param[in] lhs Left
 * @param[in] rhs Right
 ...
 * #SAI_STATUS_INVALID_PARAMETER on failure
 */
extern sai_status_t sai_metadata_deepequal_attr_value(
        _In_ const sai_attr_metadata_t *metadata,
        _In_ const sai_attribute_t *lhs,
        _In_ const sai_attribute_t *rhs,
        _Out_ bool *result);
