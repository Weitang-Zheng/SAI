 ...
 *
 * @file    saiethernet.h
 * @brief   This module defines the Ethernet logical channel for the SAI
 */

#if !defined (__SAIETHERNET_H_)
#define __SAIETHERNET_H_

#include <saitypes.h>

/**
 * @defgroup SAIETHERNET SAI - Ethernet specific API definitions
 *
 * @{
 */

/** @brief The client ALS mode */
typedef enum _sai_ethernet_client_als_t
{
    /**
     * @brief None
     *
     ...
     */
    SAI_ETHERNET_CLIENT_ALS_LASER_SHUTDOWN,
     ...
     */
    SAI_ETHERNET_CLIENT_ALS_ETHERNET,
} sai_ethernet_client_als_t;

/** @brief Maintenance */
typedef enum _sai_ethernet_maintenance_t
{
    SAI_ETHERNET_MAINTENANCE_LF,
    SAI_ETHERNET_MAINTENANCE_RF,
    SAI_ETHERNET_MAINTENANCE_IDLE,
    SAI_ETHERNET_MAINTENANCE_NONE,
} sai_ethernet_maintenance_t;

/**
 * @brief Ethernet attribute IDs
 */
typedef enum _sai_ethernet_attr_t
{
    /**
     * @brief Start of attributes
     */
    SAI_ETHERNET_ATTR_START,
     ...
     */
    SAI_ETHERNET_ATTR_CHANNEL_ID = SAI_ETHERNET_ATTR_START,
     ...
     * @flags CREATE_AND_SET
     */
    SAI_ETHERNET_ATTR_ALS_DELAY,

    /**
     * @brief Maintenance
     *
     * @type sai_ethernet_maintenance_t
     * @flags CREATE_AND_SET
     */
    SAI_ETHERNET_ATTR_MAINTENANCE,
     ...
     * @flags CREATE_AND_SET
     */
    SAI_ETHERNET_ATTR_CLIENT_RX_ALS_DELAY,
     ...
     */
    SAI_ETHERNET_ATTR_END,

    /** Custom range base value */
    SAI_ETHERNET_ATTR_CUSTOM_RANGE_START = 0x10000000,

    /** End of custom range base */
    SAI_ETHERNET_ATTR_CUSTOM_RANGE_END
 ...
 * @param[in] switch_id switch id on which the Ethernet exists
 * @param[in] attr_count Number of attributes
 * @param[in] attr_list Array of attributes
 *
 * @return #SAI_STATUS_SUCCESS on success, failure status code on error
 */
typedef sai_status_t (*sai_create_ethernet_fn)(
        _Out_ sai_object_id_t *ethernet_id,
 ...
 * @return #SAI_STATUS_SUCCESS on success, failure status code on error
 */
typedef sai_status_t (*sai_remove_ethernet_fn)(
        _In_ sai_object_id_t ethernet_id);
 ...
 * @return #SAI_STATUS_SUCCESS on success, failure status code on error
 */
typedef sai_status_t (*sai_set_ethernet_attribute_fn)(
        _In_ sai_object_id_t ethernet_id,
 ...
 * @return #SAI_STATUS_SUCCESS on success, failure status code on error
 */
typedef sai_status_t (*sai_get_ethernet_attribute_fn)(
        _In_ sai_object_id_t ethernet_id,
        _In_ uint32_t attr_count,
 ...
 * @return #SAI_STATUS_SUCCESS on success, failure status code on error
 */
typedef sai_status_t (*sai_get_ethernet_stats_fn)(
        _In_ sai_object_id_t ethernet_id,
 ...
 * @return #SAI_STATUS_SUCCESS on success, failure status code on error
 */
typedef sai_status_t (*sai_get_ethernet_stats_ext_fn)(
        _In_ sai_object_id_t ethernet_id,
        _In_ uint32_t number_of_counters,
        _In_ const sai_stat_id_t *counter_ids,
 ...
 * @return #SAI_STATUS_SUCCESS on success, failure status code on error
 */
typedef sai_status_t (*sai_clear_ethernet_stats_fn)(
        _In_ sai_object_id_t ethernet_id,
        _In_ uint32_t number_of_counters,
        _In_ const sai_stat_id_t *counter_ids);

/**
 * @brief Ethernet methods table retrieved with sai_api_query()
 */
typedef struct _sai_ethernet_api_t
{
    sai_create_ethernet_fn                create_ethernet;
    sai_remove_ethernet_fn                remove_ethernet;
    sai_set_ethernet_attribute_fn         set_ethernet_attribute;
    sai_get_ethernet_attribute_fn         get_ethernet_attribute;
    sai_get_ethernet_stats_fn             get_ethernet_stats;
    sai_get_ethernet_stats_ext_fn         get_ethernet_stats_ext;
    sai_clear_ethernet_stats_fn           clear_ethernet_stats;
} sai_ethernet_api_t;

/**
 * @}
 */
#endif /** __SAIETHERNET_H_ */
