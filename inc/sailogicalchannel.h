 ...
 *
 * @file    sailogicalchannel.h
 * @brief   This module defines the logical channel for the SAI
 */

#if !defined (__SAILOGICALCHANNEL_H_)
#define __SAILOGICALCHANNEL_H_

#include <saitypes.h>

/**
 * @defgroup SAILOGICALCHANNEL SAI - Logical channel specific API definitions
 *
 * @{
 */
