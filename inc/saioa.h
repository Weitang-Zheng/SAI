...
/** @brief OA type */
typedef enum _sai_oa_type_t
{
    SAI_OA_TYPE_EDFA,
    SAI_OA_TYPE_FORWARD_RAMAN,
    SAI_OA_TYPE_BACKWARD_RAMAN,
    SAI_OA_TYPE_HYBRID,
} sai_oa_type_t;

/** @brief OA gain range */
typedef enum _sai_oa_gain_range_t
{
    SAI_OA_GAIN_RANGE_LOW_GAIN_RANGE,
    SAI_OA_GAIN_RANGE_MID_GAIN_RANGE,
    SAI_OA_GAIN_RANGE_HIGH_GAIN_RANGE,
    SAI_OA_GAIN_RANGE_FIXED_GAIN_RANGE,
} sai_oa_gain_range_t;

/** @brief OA amp mode */
typedef enum _sai_oa_amp_mode_t
{
    SAI_OA_AMP_MODE_CONSTANT_POWER,
    SAI_OA_AMP_MODE_CONSTANT_GAIN,
    SAI_OA_AMP_MODE_DYNAMIC_GAIN,
    SAI_OA_AMP_MODE_DYNAMIC_POWER,
} sai_oa_amp_mode_t;

/** @brief OA fiber type profile */
typedef enum _sai_oa_fiber_type_profile_t
{
    SAI_OA_FIBER_TYPE_PROFILE_DSF,
    SAI_OA_FIBER_TYPE_PROFILE_LEAF,
    SAI_OA_FIBER_TYPE_PROFILE_SSMF,
    SAI_OA_FIBER_TYPE_PROFILE_TWC,
    SAI_OA_FIBER_TYPE_PROFILE_TWRS,
} sai_oa_fiber_type_profile_t;

/** @brief OA working state */
typedef enum _sai_oa_working_state_t
{
    SAI_OA_WORKING_STATE_LOS_A,
    SAI_OA_WORKING_STATE_LOS_N,
} sai_oa_working_state_t;

/**
 * @brief OA attribute IDs
 */
typedef enum _sai_oa_attr_t
{
    /**
     ...
     * @brief Gain range
     *
     * @type sai_oa_gain_range_t
     * @flags CREATE_AND_SET
     */
    SAI_OA_ATTR_GAIN_RANGE,

    /**
     * @brief Amp mode
     *
     * @type sai_oa_amp_mode_t
     * @flags CREATE_AND_SET
     */
    SAI_OA_ATTR_AMP_MODE,
     ...
     *
     * @type sai_oa_fiber_type_profile_t
     * @flags CREATE_AND_SET
     */
    ...
    SAI_OA_ATTR_CUSTOM_RANGE_START = 0x10000000,

    /** End of custom range base */
    SAI_OA_ATTR_CUSTOM_RANGE_END
 ...
 */
typedef sai_status_t (*sai_create_oa_fn)(
        _Out_ sai_object_id_t *oa_id,
 ...
 * @return #SAI_STATUS_SUCCESS on success, failure status code on error
 */
typedef sai_status_t (*sai_remove_oa_fn)(
        _In_ sai_object_id_t oa_id);
 ...
 * @return #SAI_STATUS_SUCCESS on success, failure status code on error
 */
typedef sai_status_t (*sai_set_oa_attribute_fn)(
        _In_ sai_object_id_t oa_id,
 ...
 * @return #SAI_STATUS_SUCCESS on success, failure status code on error
 */
typedef sai_status_t (*sai_get_oa_attribute_fn)(
        _In_ sai_object_id_t oa_id,
        _In_ uint32_t attr_count,
 ...
 * @return #SAI_STATUS_SUCCESS on success, failure status code on error
 */
typedef sai_status_t (*sai_get_oa_stats_fn)(
        _In_ sai_object_id_t oa_id,
 ...
 * @return #SAI_STATUS_SUCCESS on success, failure status code on error
 */
typedef sai_status_t (*sai_get_oa_stats_ext_fn)(
        _In_ sai_object_id_t oa_id,
        _In_ uint32_t number_of_counters,
        _In_ const sai_stat_id_t *counter_ids,
 ...
 * @return #SAI_STATUS_SUCCESS on success, failure status code on error
 */
typedef sai_status_t (*sai_clear_oa_stats_fn)(
        _In_ sai_object_id_t oa_id,
        _In_ uint32_t number_of_counters,
        _In_ const sai_stat_id_t *counter_ids);
 ...
 */
typedef struct _sai_oa_api_t
{
    sai_create_oa_fn                create_oa;
    sai_remove_oa_fn                remove_oa;
    sai_set_oa_attribute_fn         set_oa_attribute;
    sai_get_oa_attribute_fn         get_oa_attribute;
    sai_get_oa_stats_fn             get_oa_stats;
    sai_get_oa_stats_ext_fn         get_oa_stats_ext;
    sai_clear_oa_stats_fn           clear_oa_stats;
} sai_oa_api_t;
